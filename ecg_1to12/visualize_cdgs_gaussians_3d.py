...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="cdg_2",
        choices=("cdgs", "cdg_2", "cdg_3", "cdg_4", "cdg_5", "cdg_6", "cdg_7", "cdg_8", "cdg_10", "cdg_11", "cdg_12", "cdg_13"),
    )
    ...
    sys.path.insert(0, str(base_dir / "ecg_models"))
    sys.path.insert(0, str(base_dir / "ecg_models" / "ecg-recon"))
    from models import CDGS, CDGS2, CDGS3, CDGS4, CDGS5, CDGS6, CDGS7, CDGS8, CDGS10, CDGS11, CDGS12, CDGS13  # noqa: E402
    ...
    if args.model in ("cdg_12", "cdg_13"):
    ...
    with torch.no_grad():
        if args.model in ("cdg_10", "cdg_11", "cdg_12", "cdg_13"):
            ...
            _, _, extras = model(x, meta=meta, lead_id=lead_id)
        else:
    ...
    if args.model in ("cdg_8", "cdg_10", "cdg_11", "cdg_12", "cdg_13"):
        ...
        interior = args.model in ("cdg_3", "cdg_6", "cdg_7", "cdg_8", "cdg_10", "cdg_11", "cdg_12", "cdg_13")
